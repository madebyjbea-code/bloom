...
export const COMMON_SERVINGS: Record<string, ServingInfo> = {
  ...
  // ── Condiments, sweeteners & spreads (tbsp/tsp default) ──────────────────
  'honey':                  { grams: 21,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'maple syrup':            { grams: 20,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'agave':                  { grams: 21,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'agave syrup':            { grams: 21,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'sugar':                  { grams: 12,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'white sugar':            { grams: 12,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'brown sugar':            { grams: 9,   unitLabel: 'tsp',                 pluralLabel: 'tsp' },
  'coconut sugar':          { grams: 12,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'golden syrup':           { grams: 21,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'treacle':                { grams: 21,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'molasses':               { grams: 20,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'jam':                    { grams: 20,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'marmalade':              { grams: 20,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'peanut butter':          { grams: 32,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'almond butter':          { grams: 32,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'tahini':                 { grams: 15,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'butter':                 { grams: 14,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'ghee':                   { grams: 14,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'cream':                  { grams: 15,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'sour cream':             { grams: 28,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'cream cheese':           { grams: 29,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'hummus':                 { grams: 30,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'soy sauce':              { grams: 16,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'balsamic vinegar':       { grams: 16,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'apple cider vinegar':    { grams: 15,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'ketchup':                { grams: 17,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'mayonnaise':             { grams: 14,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'mustard':                { grams: 5,   unitLabel: 'tsp',                 pluralLabel: 'tsp' },
  'hot sauce':              { grams: 5,   unitLabel: 'tsp',                 pluralLabel: 'tsp' },
  'fish sauce':             { grams: 18,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'worcestershire sauce':   { grams: 17,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },

  // ── Dairy extras ─────────────────────────────────────────────────────────
  'heavy cream':            { grams: 15,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'whipping cream':         { grams: 15,  unitLabel: 'tbsp',                pluralLabel: 'tbsp' },

  // ── Sweet extras ─────────────────────────────────────────────────────────
  'dark chocolate':         { grams: 28,  unitLabel: 'square (approx 28g)', pluralLabel: 'squares' },
  'milk chocolate':         { grams: 28,  unitLabel: 'square (approx 28g)', pluralLabel: 'squares' },
  'dark chocolate chips':   { grams: 28,  unitLabel: 'handful',             pluralLabel: 'handfuls' },
  'cacao powder':           { grams: 7,   unitLabel: 'tbsp',                pluralLabel: 'tbsp' },
  'cocoa powder':           { grams: 7,   unitLabel: 'tbsp',                pluralLabel: 'tbsp' },

  // ── Drinks ───────────────────────────────────────────────────────────────
  'orange juice':           { grams: 240, unitLabel: 'glass',               pluralLabel: 'glasses' },
  'apple juice':            { grams: 240, unitLabel: 'glass',               pluralLabel: 'glasses' },
  'grape juice':            { grams: 240, unitLabel: 'glass',               pluralLabel: 'glasses' },
  'fruit juice':            { grams: 240, unitLabel: 'glass',               pluralLabel: 'glasses' },
  'smoothie':               { grams: 300, unitLabel: 'glass',               pluralLabel: 'glasses' },
  'coffee':                 { grams: 240, unitLabel: 'cup',                 pluralLabel: 'cups' },
  'espresso':               { grams: 30,  unitLabel: 'shot',                pluralLabel: 'shots' },
  'oat milk':               { grams: 240, unitLabel: 'cup',                 pluralLabel: 'cups' },
  'almond milk':            { grams: 240, unitLabel: 'cup',                 pluralLabel: 'cups' },
  'soy milk':               { grams: 240, unitLabel: 'cup',                 pluralLabel: 'cups' },
